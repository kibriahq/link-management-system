...
const navItems = [
  ...
  { name: 'URL Management', href: '/manage', icon: 'link' },
  { name: 'Bulk Generator', href: '/generate/bulk', icon: 'layers' },
...
export default function Sidebar() {
  ...
  return (
    <>
      ...
      {/* Sidebar */}
      <aside className={`fixed left-0 top-0 h-screen w-[240px] border-r border-slate-200 bg-slate-50 flex flex-col py-6 px-4 z-50 transition-transform duration-300 lg:translate-x-0 ${
