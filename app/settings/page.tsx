...
export default function SettingsPage() {
  ...
  const [settings, setSettings] = useState({
    ...
    twoFactorAuth: false,
    apiAccess: false,
    defaultRedirect: profile?.default_redirect || '',
    qrCodeFormat: 'png',
    qrCodeSize: 300,
  });
  ...
  const tabs = [
    ...
    { id: 'integrations', name: 'Integrations', icon: 'extension', disabled: true },
    { id: 'api', name: 'API Keys', icon: 'key', disabled: true },
    { id: 'billing', name: 'Billing', icon: 'credit_card', disabled: true },
  ];
          ...
          {activeTab === 'general' && (
            <div className="bg-white border border-slate-200 rounded-xl p-6 space-y-6">
              ...
              <div className="pt-4 border-t border-slate-200 flex justify-end">
                <button onClick={handleSave} className="px-6 py-2 bg-[#0066ff] text-white font-semibold rounded-lg hover:opacity-90 transition-opacity">
                  Save Changes
                </button>
              </div>
            </div>
              ...
              <div className="space-y-4">
                <div className="flex items-center justify-between p-4 border border-slate-200 rounded-lg">
                  ...
                  <button
                    ...
                    disabled={true}
                    className={`w-12 h-6 rounded-full transition-colors ${settings.twoFactorAuth ? 'bg-[#0066ff]' : 'bg-slate-200'
                      }`}
                  >
                    <div className={`w-5 h-5 rounded-full bg-white shadow transform transition-transform ${settings.twoFactorAuth ? 'translate-x-6' : 'translate-x-0.5'
                      }`}></div>
                  </button>
                </div>
                ...
                <div className="flex items-center justify-between p-4 border border-slate-200 rounded-lg">
                  ...
                  <button
                    ...
                    disabled={true}
                    className={`w-12 h-6 rounded-full transition-colors ${settings.apiAccess ? 'bg-[#0066ff]' : 'bg-slate-200'
                      }`}
                  >
                    <div className={`w-5 h-5 rounded-full bg-white shadow transform transition-transform ${settings.apiAccess ? 'translate-x-6' : 'translate-x-0.5'
                      }`}></div>
                  </button>
                </div>
              </div>
              ...
              <div className="space-y-4">
                <div className="flex items-center justify-between p-4 border border-slate-200 rounded-lg">
                  ...
                  <button
                    ...
                    className={`w-12 h-6 rounded-full transition-colors ${settings.emailNotifications ? 'bg-[#0066ff]' : 'bg-slate-200'
                      }`}
                  >
                ...
                <div className="flex items-center justify-between p-4 border border-slate-200 rounded-lg">
                  ...
                  <button
                    ...
                    className={`w-12 h-6 rounded-full transition-colors ${settings.slackNotifications ? 'bg-[#0066ff]' : 'bg-slate-200'
                      }`}
                  >
                    <div className={`w-5 h-5 rounded-full bg-white shadow transform transition-transform ${settings.slackNotifications ? 'translate-x-6' : 'translate-x-0.5'
                      }`}></div>
                  </button>
                </div>
              </div>
